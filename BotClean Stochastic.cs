...
class Solution {
	...
	static void nextMove(int posr, int posc, String [] board){
        ...
        //while(listaObjetos.Count!=0)
        {
                
        //Console.WriteLine("posicion Boot. X: "+r+". Y: "+c);
        ...
        if(idElim>=0)
        {
            ...
            //Console.WriteLine("eliminado: "+idElim+". XY: "+posBoot.X+" "+posBoot.Y+". Quedan: "+listaObjetos.Count);
        ...
        /*
        foreach(CeldaDist x in lista)
        {
            Console.WriteLine(x.caso+" x: "+x.ubic.X+" y: "+x.ubic.Y+" dist: "+x.dist);
        }*/
        ...
        //Console.WriteLine("inicio Boot XY: "+posBoot.X+" "+posBoot.Y);
        //Console.WriteLine("proximo Princ XY: "+posPrinc.X+" "+posPrinc.Y);
        
        //while(!(posBoot.X==posPrinc.X && posBoot.Y==posPrinc.Y))    
        //if(!(posBoot.X==posPrinc.X && posBoot.Y==posPrinc.Y))   
        {
            string comando = "";
            ...
            //Console.WriteLine("Boot XY: "+posBoot.X+" "+posBoot.Y);
            //Console.WriteLine("=======================");
            
            //nextMove(posBoot.X,posBoot.Y,  grid);
        }
    ...
    static string obtenerDesplazamiento(ref String [] grid, ref Point posBoot, Point posPrinc)
    {
        ...
        //Console.WriteLine("dist UP: "+ dist[0]);
        //Console.WriteLine("dist RIGHT: "+dist[1]);
        //Console.WriteLine("dist DOWN: "+dist[2]);
        //Console.WriteLine("dist LEFT: "+dist[3]);
        
        
        int idx = obtenerIndice(dist);
        
        //Console.WriteLine("min idx: "+idx+". valor: "+dist[idx]);
    ...
    static int obtenerIndice(double [] dist){
        ...
        //Console.WriteLine("dist.GetLength(0): "+dist.GetLength(0));
        for(int i=0;i<dist.GetLength(0);i++)
        {
            //Console.WriteLine("i: "+i+" dist["+i+"]="+dist[i]);
    ...
    static double obtenerDistancia(Point posXY, Point posPrinc, int n){
        //Console.WriteLine("XY temp: "+posXY.X+" Y: "+posXY.Y);
